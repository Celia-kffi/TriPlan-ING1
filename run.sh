...
#Envoi du fichier JAR sur la VM
 scp -P 121 xmart-zity-backend-1.0-SNAPSHOT-jar-with-dependencies.jar backend@172.31.250.95:/home/backend/backend1.jar
...
ssh -p 121 backend@172.31.250.95 "java -jar /home/backend/backend1.jar"
